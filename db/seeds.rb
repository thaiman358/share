...
Article.create(arttype: '1', title: '＜事例紹介＞商社', content: 'テスト：商社事例紹介', industry: '1')
Article.create(arttype: '1', title: '＜事例紹介＞メーカー', content: 'テスト：メーカー事例紹介', industry: '2')
Article.create(arttype: '1', title: '＜事例紹介＞小売り', content: 'テスト：小売り事例紹介', industry: '3')
Article.create(arttype: '1', title: '＜事例紹介＞金融', content: 'テスト：金融事例紹介', industry: '4')
Article.create(arttype: '1', title: '＜事例紹介＞タクシーをより使いやすい移動手段に変革した「Uber」', content: '自動車配車サービス「Uber」は、デジタル・トランスフォーメーションの事例として国内外で度々取り上げられています。Uberは、GPSが搭載されたスマートフォンアプリを活用することで、これまで人手に頼らざるを得なかった「配車依頼を受け取る」「ドライバーに指示をする」というプロセスをデジタル化し効率化することに成功しました。その結果、生活者はスマートフォン上から従来よりも気軽に配車できるようになりました。', industry: '5')
Article.create(arttype: '1', title: '＜事例紹介＞物流', content: 'テスト：物流事例紹介', industry: '6')
Article.create(arttype: '1', title: '＜事例紹介＞建設・不動産', content: 'テスト：建設・不動産事例紹介', industry: '7')
...
Article.create(arttype: '3', title: '＜業界動向＞商社', content: 'テスト商社業界動向', industry: '1')
Article.create(arttype: '3', title: '＜業界動向＞メーカー', content: 'テスト：メーカー業界動向', industry: '2')
Article.create(arttype: '3', title: '＜業界動向＞小売り', content: 'テスト：小売り業界動向', industry: '3')
Article.create(arttype: '3', title: '＜業界動向＞金融', content: 'テスト：金融業界動向', industry: '4')
Article.create(arttype: '3', title: '＜業界動向＞インフラ', content: 'テスト：インフラ業界動向', industry: '5')
Article.create(arttype: '3', title: '＜業界動向＞物流', content: 'テスト：物流業界動向', industry: '6')
Article.create(arttype: '3', title: '＜業界動向＞建設・不動産', content: 'テスト：建設・不動産業界動向', industry: '7')
Article.create(arttype: '3', title: '＜業界動向＞サービス業', content:'テスト：サービス業業界動向', industry: '8')
Article.create(arttype: '3', title: '＜業界動向＞広告・マスコミ', content: 'テスト：広告・マスコミ業界動向', industry: '9')
Article.create(arttype: '3', title: '＜業界動向＞ソフトウェア・通信', content: 'テスト：ソフトウェア・通信業界動向', industry: '10')
Article.create(arttype: '3', title: '＜業界動向＞公務員', content: 'テスト：公務員業界動向', industry: '11')
