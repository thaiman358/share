...
Article.create(arttype: '3', title: '＜業界動向＞商社', content: 'テスト商社', industry: '1')
Article.create(arttype: '3', title: '＜業界動向＞メーカー', content: 'テスト：メーカー', industry: '2')
Article.create(arttype: '3', title: '＜業界動向＞小売り', content: 'テスト：小売り', industry: '3')
Article.create(arttype: '3', title: '＜業界動向＞金融', content: 'テスト：金融', industry: '4')
Article.create(arttype: '3', title: '＜業界動向＞インフラ', content: 'テスト：インフラ', industry: '5')
Article.create(arttype: '3', title: '＜業界動向＞物流', content: 'テスト：物流', industry: '6')
Article.create(arttype: '3', title: '＜業界動向＞建設・不動産', content: 'テスト：建設・不動産', industry: '7')
Article.create(arttype: '3', title: '＜業界動向＞サービス業', content:'テスト：サービス業', industry: '8')
Article.create(arttype: '3', title: '＜業界動向＞広告・マスコミ', content: 'テスト：広告・マスコミ', industry: '9')
Article.create(arttype: '3', title: '＜業界動向＞ソフトウェア・通信', content: 'テスト：ソフトウェア・通信', industry: '10')
Article.create(arttype: '3', title: '＜業界動向＞公務員', content: 'テスト：公務員', industry: '11')
